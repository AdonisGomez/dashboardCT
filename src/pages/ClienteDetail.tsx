      ...
      {notification && (
        ...
        >
          <div className="flex items-center">
            ...
            <div className={`text-sm ${notification.type === 'success' ? 'text-emerald-300' : 'text-red-300'}`}>
      ...
      <div className="card rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-slate-700/50 mb-4 sm:mb-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
          <button
            ...
            disabled={actionLoading !== null || !canWrite()}
            ...
            title={!canWrite() ? 'Solo lectura: No puedes ejecutar acciones' : 'Iniciar servicios'}
          >
          ...
          <button
            ...
            title={!canWrite() ? 'Solo lectura: No puedes ejecutar acciones' : 'Detener servicios'}
          >
          ...
          <button
            ...
            title={!canWrite() ? 'Solo lectura: No puedes ejecutar acciones' : 'Reiniciar servicios'}
          >
